...
type UserStore interface {
	...
	UpdateUser(context.Context, interface{}, types.UpdateUserParams) error
}
...
func (s *MongoUserStore) UpdateUser(ctx context.Context, filter interface{}, values types.UpdateUserParams) error {
	update := bson.D{
		{
